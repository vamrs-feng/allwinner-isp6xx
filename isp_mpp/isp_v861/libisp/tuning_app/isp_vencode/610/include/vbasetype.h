...
//* 1. just valid decodder-lbc-mode on tina-linux-platform now,
//*    as the function add some variable in common struct such as struct of VConfig/FbmBufInfo/VideoPicture.
//* 2. should enable decoder-lbc-mode when release next version of cedarc
...
enum EPIXELFORMAT
{
    ...
    PIXEL_FORMAT_AW_NV12_10BIT       = 24,
    PIXEL_FORMAT_AW_NV21_10BIT       = 25,
    PIXEL_FORMAT_AW_YV12_10BIT       = 26,
    PIXEL_FORMAT_AW_I420_10BIT       = 27,
    PIXEL_FORMAT_AW_AFBC             = 28,
    PIXEL_FORMAT_AW_AFBC_10BIT       = 29,
    PIXEL_FORMAT_AW_P010_LE_UV       = 30,
    PIXEL_FORMAT_AW_P010_LE_VU       = 31,

    PIXEL_FORMAT_MIN = PIXEL_FORMAT_DEFAULT,
    PIXEL_FORMAT_MAX = PIXEL_FORMAT_AW_P010_LE_VU,
};
